...
<main class="main-pharmacy">
  ...
  <div class="pharmacy">
    ...
    <div class="position-table">
      ...
      <div class="table-link-ubication">
        <a id="1" href="mapas/viaespana.jsp" class="link-ubication-pharmacy">
          <%
  ...
  <div class="pharmacy">
    ...
    <div class="position-table">
      ...
      <div class="table-link-ubication">
        <a href="mapas/plazaedison.jsp"  class="link-ubication-pharmacy">
          <%
  ...
  <div class="pharmacy">
    ...
    <div class="position-table">
      ...
      <div class="table-link-ubication">
        <a href="mapas/avedomingodiaz.jsp" class="link-ubication-pharmacy">
          <%
  ...
  <div class="pharmacy">
    ...
    <div class="position-table">
      ...
      <div class="table-link-ubication">
        <a href="mapas/veraguas.jsp" class="link-ubication-pharmacy">
          <%
  ...
  <div class="pharmacy">
    ...
    <div class="position-table">
      ...
      <div class="table-link-ubication">
        <a  href="mapas/arraijan.jsp" class="link-ubication-pharmacy">
          <%
  ...
  <div class="mapa-url">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d141395.2526903828!2d-79.66657193738362!3d8.965066538271714!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8faca8f5ec2b89df%3A0xaab69f7cec5c703b!2sFarmacia%20El%20Javillo%20%7C%20Plaza%20Edison!5e0!3m2!1ses-419!2spa!4v1669964947051!5m2!1ses-419!2spa"  width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </div>
